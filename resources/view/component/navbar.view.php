  ...
  <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    ...
    <div class="hidden lg:flex lg:gap-x-12">
      <div class="relative">
        ...
        -->
        <div id="flayout" class="absolute top-full -left-8 z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white ring-1 shadow-lg ring-gray-900/5 hidden">
          <div class="p-4">
...
<script>
  // TODO : script per toggle su menu principale in desktop/mobile
</script>